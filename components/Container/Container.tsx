    ...
    <>
      ...
      >
        <Head>
          ...
          <meta
            property='og:url'
            content={`https://cortesdev.de/${router.asPath}`}
          />
          <link
            rel='canonical'
            href={`https://cortesdev.de/${router.asPath}`}
          />
          <meta property='og:type' content={meta.type} />
          <meta property='og:site_name' content='Youerer name h' />
          <meta property='og:description' content={meta.description} />
          <meta property='og:title' content={meta.title} />
          <meta property='og:image' content={meta.image} />
          <meta name='twitter:card' content='summary_large_image' />
          <meta name='twitter:site' content='@cortesdev' />
        ...
        <nav className='sticky w-full bg-gray-100/40 z-[1] filter-blur dark:bg-gray-1000/40 top-2 md:top-4 max-w-2xl px-4 py-2 rounded-md mx-auto flex justify-between items-center'>
          ...
          <div className='flex flex-row items-center space-x-4'>
            <a
              href='https://github.com/cortesdev/'
              className='visible'
              target='_blank'
              rel='noreferrer'
              aria-label='Github'
