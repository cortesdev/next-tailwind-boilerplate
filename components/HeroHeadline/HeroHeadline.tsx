...
export default function HeroHeadline({ slides }: HeroHeadlineProps) {
  ...
  return (
    <div className='flex flex-col items-center text-6xl font-extrabold tracking-tight md:text-9xl'>
      <div className='flex flex-col items-center'>
        <p className='text-2xl tracking-normal sm:text-3xl'>The latest</p>
        ...
        <p className='mt-6 text-lg font-medium tracking-normal text-tertiary'>
          Edit pages/index.tsx and get started. 🚀
        </p>
      </div>
    </div>
  )
